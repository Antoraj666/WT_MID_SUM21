...
<html>
    ...
    <td><input type="date" name="begin"
        ...
        min="1987-01-01" max="2021-12-31"></td>
				  </tr>
          <tr>
            <td>Work hours starts:</td>
            <td><input type="time" name="begin" placeholder="Work hours begins"></td>
          </tr>
          <tr>
            <td>Work hours ends:</td>
            <td><input type="time" name="begin" placeholder="Work hours ends"></td>
          </tr>
					<tr>
